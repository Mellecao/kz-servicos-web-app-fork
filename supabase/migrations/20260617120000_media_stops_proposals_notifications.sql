...
-- Public media buckets used by all three apps.
...
-- Driver proposal review workflow.
...
-- Device push token compatibility. The canonical table remains user_devices,
-- but these columns keep the current mobile apps functional.
...
-- Ensure requested services appear first in the client service chips.
