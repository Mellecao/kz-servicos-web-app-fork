-- ============================================================================
-- Migration: Driver trip cancellation requests reviewed by admins
-- ============================================================================
...
BEGIN
  IF EXISTS (
    ...
    ALTER PUBLICATION supabase_realtime
      DROP TABLE public.trip_cancellation_requests;
  END IF;
END $$;

DROP TRIGGER IF EXISTS trg_resolve_pending_request_on_trip_cancelled
  ON public.trips;
DROP FUNCTION IF EXISTS public.resolve_pending_request_on_trip_cancelled();

DROP TRIGGER IF EXISTS trg_push_driver_trip_cancellation_rejection
  ON public.trip_cancellation_requests;
DROP FUNCTION IF EXISTS public.push_driver_trip_cancellation_rejection();

DROP TRIGGER IF EXISTS trg_apply_trip_cancellation_request_review
  ON public.trip_cancellation_requests;
DROP FUNCTION IF EXISTS public.apply_trip_cancellation_request_review();

DROP TRIGGER IF EXISTS trg_notify_admins_on_trip_cancellation_request
  ON public.trip_cancellation_requests;
DROP FUNCTION IF EXISTS public.notify_admins_on_trip_cancellation_request();

DROP TRIGGER IF EXISTS trg_validate_trip_cancellation_request_review
  ON public.trip_cancellation_requests;
DROP FUNCTION IF EXISTS public.validate_trip_cancellation_request_review();

DROP TABLE IF EXISTS public.trip_cancellation_requests;
