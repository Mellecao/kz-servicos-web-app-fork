...
-- Extensao pg_net e pre-requisito para net.http_post usado nos triggers abaixo.
-- IF NOT EXISTS torna a operacao idempotente em ambientes onde ja esta habilitada.
CREATE EXTENSION IF NOT EXISTS pg_net;

-- Trigger function para trips
...
-- Trigger function para service_requests
